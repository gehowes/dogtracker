...
//MARK: Properties
    ...
    /*
     This value is either passed by 'DogTableViewController' in 'prepare(for:sender:)' or constructed as part of adding a new dog.
     */
    var dog: Dog?
    ...
    override func viewDidLoad() {
        ...
        // Enable the save button only if the text field has a valid Dog name.
...
//MARK: Navigation
    ...
    @IBAction func cancel(_ sender: UIBarButtonItem) {
        ...
        // Depending on style of presentation (modal or push presentation), this view controller needs to be dismissed in two diffferent ways.
        ...
        if isPresentingInAddDogMode {
            ...
            fatalError("The DogViewController is not inside a anvigation controller.")
        }
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        // Set the dog to be passed to DogTrackerViewController after the unwind segue.
